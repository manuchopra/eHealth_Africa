...
function Asteroids() {
	...
	*/
	...
	function code(name) {
		var table = {'up': 38, 'down': 40, 'left': 37, 'right': 39, 'esc': 27, 'M' : 77};
	...
	*/
	...
	addEvent(this.canvas, 'mousedown', function(e) {
		...
		message.innerHTML = 'Press Esc to quit. Space Bar to shoot. M for epic music';
	...
	if ( ! document.getElementById('ASTEROIDS-NAVIGATION') ) {
		...
		this.appstore.innerHTML = '<a class="ASTEROIDSYEAH" target="_blank" ><img src="" class="ASTEROIDSYEAH" style="border: none"  /></a>';
